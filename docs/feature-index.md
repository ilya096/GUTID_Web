...
| object_interaction | 3D Object Interaction | Детекция приближения/наведения на артефакт с всплывающей info-панелью | Детальный контекст и история каждого объекта | MVP | hall_environment | all | pending | TBD |
| poster_display | 2D Poster Display | Размещение 30–40 плакатов на стенах зала | Визуальная историческая справка | MVP | hall_environment | all | pending | TBD |
