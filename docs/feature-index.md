...
| poster_display | 2D Poster Display | Размещение 30–40 плакатов на стенах зала | Визуальная историческая справка | MVP | hall_environment | all | in_progress | 2026-06-07_poster_display_gd-spec.md |
